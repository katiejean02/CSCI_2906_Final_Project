...
public class battleshipPlayer1 extends Application{
   ...
   String[][] myArray = new String[5][9];
         ...
         hbox.setSpacing(0);
            for(int col = 1; col < 11; col++){
               if(row == 0){
                  ...
                  Bounds Label = label.localToScene(label.getBoundsInLocal());
                  String labelBounds = String.format(label+"%.2f,%.2f,%.2f,%.2f",Label.getMinX(),Label.getMinY(),Label.getMaxX(),Label.getMaxY());
                  Labels[col] = labelBounds;
               }else if(row == 1){
      ...
      File file = new File("battleshipPlayer2.txt");
      ...
      finish.setOnAction(e ->{
         ...
         try{
            DataOutputStream output1 = new DataOutputStream(new FileOutputStream("battleshipPlayer1.txt"));
        ...
        tA.setWrapText(true);
        root.getChildren().addAll(p1,p2,p3,start,finish,tA);
        finish.setAlignment(Pos.CENTER_RIGHT);
        VBox root1 = new VBox();
        ...
        primaryStage.setTitle("Battleship Player1");
